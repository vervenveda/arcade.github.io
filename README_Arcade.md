...
Arcade™ brings together classic board games, word play, visual logic, creative experiments, trivia, action games, and simulations in a single searchable game hall. The current registry contains **42 verified cabinets**, organized into six clear categories and designed to run as static HTML on GitHub Pages.

---

## Arcade Overview

- **42 playable game cabinets**
- **6 organized game categories**
